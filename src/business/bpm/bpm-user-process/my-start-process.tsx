...
class MyStartProcess extends React.Component {
                ...
                <div style={{marginLeft: "10px"}}>
                    {
                        array.map((value, index) => (
                            <div key={index} style={{ width: "19.3%", marginRight: "10px", marginBottom: "10px", float: "left" }}>
                                <Card size="small" title={'行政办公'+ value}
                                    ...
                                    >
                                        ...
                                        <a title="自身主动与他人做对比：同样一件事情，人家做到什么程度，你能做到什么程度，人家是怎么做的，你是怎么做的，总的来说，不比不知道，一比吓一跳。通过比较你就知道自己的思路，行动的差距在哪里。
                                            ...
                                            <Paragraph ellipsis={{ rows: 3 }} style={{ backgroundColor: "rgba(245,245,245,1)", borderRadius: "2px", marginTop: "10px", marginBottom: "0", padding: "5px" }}>
