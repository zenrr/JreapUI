...
const mapDispatchToProps = (dispatch: any): method => {
    return {
        switchProcessTraceUI: (e, id): void => { //流程痕迹
            console.log("haha")
        },
        switchProcessHandleUI: (e, id): void => { // 流程办理
            console.log("hehe")
        },
        switchProcesstransferUI: (e, id): void => { // 流程转办

        },
        switchProcessIncreaseSignUI: (e, id): void => { // 流程增签

        },
        switchProcessReduceSignUI: (e, id): void => { // 流程减签
