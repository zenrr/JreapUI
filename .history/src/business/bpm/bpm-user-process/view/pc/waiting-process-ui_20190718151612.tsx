...
// interface method {
//     switchProcessTrace(id: string): void 
//     switchProcessHandle(id: string): void
//     switchProcesstransfer(id: string): void
//     switchProcessIncreaseSign(id: string): void
//     switchProcessReduceSign(id: string): void
// }
                                ...
                                <Card size="small" 
                                    ...
                                    >
                                        ...
                                        <Row gutter={12}>
                                            ...
                                            <Col span={6}><Button size="small" block onClick={ () => {props.switchProcessHandleUI(index) } }>办理</Button></Col>
                                            <Col span={6}><Button size="small" block onClick={props.switchProcessHandleUI.bind(this, index)}>办理</Button></Col>
                                            <Col span={6}><Button size="small" block onClick={props.switchProcesstransferUI.bind(this, index)}>转办</Button></Col>
                                            <Col span={6}><Button size="small" block onClick={props.switchProcessIncreaseSignUI.bind(this, index)}>增签</Button></Col>
                                            <Col span={6}><Button size="small" block onClick={props.switchProcessReduceSignUI.bind(this, index)}>减签</Button></Col>
                                        </Row>
                                </Card>
                            </div>
                        ))
