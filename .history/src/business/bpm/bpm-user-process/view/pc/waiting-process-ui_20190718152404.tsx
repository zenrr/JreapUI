                                ...
                                <Card size="small" 
                                    ...
                                    >
                                        ...
                                        <Row gutter={12}>
                                            ...
                                            <Col span={6}>
                                                <Button size="small" block onClick={ () => {props.switchProcesstransferUI(index) } }>转办</Button>
                                            </Col>
                                            <Col span={6}> { () => {props.switchProcessIncreaseSignUI(index) } }
                                                <Button size="small" block onClick={props.switchProcessIncreaseSignUI.bind(this, index)}>增签</Button>
                                            </Col>
                                            <Col span={6}>
                                                <Button size="small" block onClick={props.switchProcessReduceSignUI.bind(this, index)}>减签</Button>
                                            </Col>
                                        </Row>
                                </Card>
                            </div>
