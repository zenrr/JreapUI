...
import { 
    ...
    bpmProcessHandlimport console = require('console');
eUiOpen,
...
const mapDispatchToProps = (dispatch: any, props: any): method => {
    return {
        ...
        openProcessReduceSignUI: (id): void => { // 打开流程减签
            const action = bpmProcessReduceSignUiOpen();
			dispatch(action);
        },
        closeProcessReduceSignUI: (): void => { // 关闭流程减签
