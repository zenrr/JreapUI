import { Form, Input, Button, DatePicker, Row, Col, Card, Avatar, Typography, Pagination } from 'antd';
import React = require('react');
import LookUpUI from '../../../components/lookUp/ui';
...
const handledImg = require('../../../assets/images/bpm-handled.png');
...
class HandledProcess extends React.Component {
                ...
                <div style={{marginLeft: "10px"}}>
                    {
                        array.map((value, index) => (
                            <div key={index} style={card}>
                                <Card size="small" title="行政办公"
                                        extra={<a><span className="icon iconfont">&#xec57;</span></a>}
                                    >
                                        ...
                                        <img src={handledImg} style={{position: "absolute", top: "85px", right: "13px"}}></img>
                                        <Row gutter={12}>
                                            <Col span={6} offset={18}><Button size="small" block>减签</Button></Col>
                                        </Row>
                                </Card>
                            </div>
                        ))
