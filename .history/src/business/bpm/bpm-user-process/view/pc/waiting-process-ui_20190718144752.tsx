...
interface _props {
    switchProcessTrace(id: any):void 
    switchProcessHandle(id: any):void
    switchProcesstransfer():void
    switchProcessIncreaseSign():void
    switchProcessReduceSign:LoginInfo
}
