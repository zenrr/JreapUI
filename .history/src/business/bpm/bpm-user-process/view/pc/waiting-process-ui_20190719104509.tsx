...
import ProcessTracesUI from './process-traces-ui';
import ProcessTransferUI from './process-transfer-ui';
import ProcessHandleUI from './process-handle-ui';
import ProcessReduceSignUI from './process-reduce-sign';
import ProcessIncreaseSignUI from './process-increase-sign';
...
const WaitingProcessUI: React.FC<any> = ({props}) => {
    ...
    return (
        <div>
            ...
            <div style={{marginLeft: "10px"}}>
                {
                    array.map((value, index) => (
                        <div key={index} style={card}>
                            <Card size="small" 
                                title="行政办公" 
                                extra={<a onClick={ () => {props.openProcessTraceUI(index) } }><span className="icon iconfont">&#xec57;</span></a>}
                                >
                                    ...
                                    <Row gutter={12}>
                                        <Col span={6}>
                                            <Button size="small" block onClick={ () => {props.openProcessHandleUI(index) } }>办理</Button>
                                        </Col>
                                        <Col span={6}>
            ...
            <div style={{ float: "right", marginRight: "10px" }}>
                <Pagination defaultCurrent={props.pageNum} total={props.total} />
            </div>
            ...
            <ProcessTracesUI 
                data = ""
                visible = {props.switchProcessTrace}
                closeMethod = {props.closeProcessTraceUI}
            />

            <ProcessHandleUI
                data = ""
                visible = {props.switchProcessHandle}
                closeMethod = {props.closeProcessHandleUI}
            />

            <ProcessTransferUI 
                data = ""
                visible = {props.switchProcessTransfer}
                closeMethod = {props.closeProcesstransferUI}
            />

closeProcessIncreaseSignUI: ƒ ()
closeProcessReduceSignUI: ƒ ()

switchProcessIncreaseSign: false
switchProcessReduceSign: false
switchProcessTrace: false

            <ProcessIncreaseSignUI
                data = ""
                visible = {props.switchProcessIncreaseSign}
                closeMethod = {props.closeProcessIncreaseSignUI}
            />

            <ProcessReduceSignUI 
                data = ""
                visible = {props.switchProcessReduceSign}
                closeMethod = {props.closeProcessReduceSignUI}
            />
