...
const WaitingProcessUI: React.FC<any> = ({props}) => {
    ...
    return (
        <div>
            ...
            />
            closeProcessHandleUI: ƒ ()
closeProcessIncreaseSignUI: ƒ ()
closeProcessReduceSignUI: ƒ ()
closeProcessTraceUI: ƒ ()
closeProcesstransferUI: ƒ ()
openProcessHandleUI: ƒ (id)
openProcessIncreaseSignUI: ƒ (id)
openProcessReduceSignUI: ƒ (id)
openProcessTraceUI: ƒ (id)
openProcesstransferUI: ƒ (id)
pageNum: 1
pageSize: 10
sWitchProcessTransfer: false
switchProcessHandle: false
