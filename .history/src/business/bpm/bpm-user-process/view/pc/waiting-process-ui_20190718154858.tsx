import { Form, Icon, Input, Button, DatePicker, Row, Col, Card, Avatar, Typography, Pagination, Drawer } from 'antd';
                ...
                <div style={{marginLeft: "10px"}}>
                    {
                        array.map((value, index) => (
                            <div key={index} style={card}>
                                <Card size="small" 
                                    title="行政办公" 
                                    extra={<a onClick={ () => {props.switchProcessTraceUI(index) } }><span className="icon iconfont">&#xec57;</span></a>}
                                    >
                                        ...
                                        <Row gutter={12}>
                                            ...
                                            <Col span={6}> 
                                                <Button size="small" block onClick={ () => {props.switchProcessReduceSignUI(index) } }>减签</Button>
                                            </Col>
                                        </Row>
                                </Card>
                            </div>
